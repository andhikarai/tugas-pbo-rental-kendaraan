...
// Status transaksi sebagai enum → lebih aman & readable
...
public class Transaksi {
    ...
    public Transaksi(String idTransaksi, Penyewa penyewa, Kendaraan kendaraan,
        ...
        hitungTotalBiaya(); // hitung otomatis saat objek dibuat
    }
    ...
    // setter lamaSewaHari tidak disediakan — dihitung otomatis

    public double getTotalBiaya() { return totalBiaya; }
    // setter tidak disediakan — dihitung internal
    ...
    public void konfirmasiPesanan() {
        if (statusTransaksi == StatusTransaksi.MENUNGGU) {
            ...
            if (kendaraan != null) {
                kendaraan.ubahStatus(false); // ubah jadi "tidak tersedia"
            }
    ...
    public void selesaikanTransaksi() {
        if (statusTransaksi == StatusTransaksi.DIPROSES) {
            ...
            if (kendaraan != null) {
                kendaraan.ubahStatus(true); // kembalikan ke "tersedia"
            }
